						...
						<div class="row">
							...
							?>
								...
								<form action="product.html" method="post">
									<input type="hidden" name="id" value="<?=$items[$i-1]["id"]?>">
									<div class="col-md-4 col-xs-6">
										<div class="product">
											<div class="product-img">
												<img src="<?=$items[$i-1]["image"]?>" alt="">										
											</div>
											<div class="product-body">
												<h3 class="product-name"><a href="#"><?=$items[$i-1]["name"]?></a></h3>
												<h4 class="product-price">Rp. <?=number_format($items[$i-1]["price"])?></h4>										
											</div>
											<div class="add-to-cart">
												<input type ="submit" class="add-to-cart-btn" value="View Item">
											</div>
										</div>
									</div>
								</form>
